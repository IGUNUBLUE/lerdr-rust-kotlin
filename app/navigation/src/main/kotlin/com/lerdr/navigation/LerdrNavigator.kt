 ...
 * - [LerdrKey.AgentFeed] and [LerdrKey.Terminal] are *modes of one session*:
 *   switching modes for the same pane replaces the top entry instead of
 *   stacking feed↔terminal ping-pong onto the back stack.
