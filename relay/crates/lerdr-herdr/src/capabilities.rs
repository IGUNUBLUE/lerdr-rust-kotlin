...
/// The tier-2 surface joins them: every relay-driven call gets schema
/// adjudication plus observed notes so an absent method stops being
/// attempted after the first definitive refusal.
